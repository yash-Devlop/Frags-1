  ...
  return (
    <nav className= " border-b-4 border-gray-400 p-2" >
      <div className= "container mx-auto flex justify-between items-center" >
        ...
        : 
          <div>
            <NavLink to = "/Login" className= "bg-black text-white border border-black px-4 mx-1 py-2 font-mono transition-colors rounded-full hover:bg-white hover:text-black" >
              Login
            </NavLink>
            <NavLink to = "/Signup" className= "bg-black text-white border border-black px-4 mx-1 py-2 font-mono transition-colors rounded-full hover:bg-white hover:text-black" >
              Sign Up
            </NavLink>
